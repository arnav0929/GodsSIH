...
import os
conn = sqlite3.connect('godseye.db')
...
# add_job("Dancer required in thapar University", "1000000", "We are looking for a passionate dancer", "expert in folk dance", "Dancer", "1")
# add_job("Singer required in thapar talks", "1000000", "We are looking for a passionate singer", "expert in singing folk songs", "singer", "1")
...
def courses_available():
    ...
    for row in cursor:
        res.append(row)
    return res
# conn.execute("delete from courses where courseID=2 or courseID=3")
# conn.commit()
...
# add_user("apoorv", "mishra", "apoorv@gmail.com", "apoorv1234")
...
# add_mentor("arnav", "arnav@gmail.com", "apoorv@abcd")
...
# print(verify_mentor("arnav@gmail.com", "apoorv@abcd", "abcdefgh"))
